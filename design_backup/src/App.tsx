...
export default function App() {
  ...
  return (
    <div className={`h-screen overflow-y-auto bg-holo-black text-white font-sans flex flex-col selection:bg-holo-blue-dark selection:text-black ${theme === "light" ? "theme-light" : ""}`}>
